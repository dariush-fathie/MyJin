...
public class DateConverter {
    ...
    public static int[] currentDate = null;
    ...
    private int[] getCurrentDate() {
        if (currentDate == null) {
            ...
            String currentTime = new SimpleDateFormat("yyyyMMdd_HHMM", Locale.UK).format(new Date());
        ...
        if (y == c[0]) {
            ...
            if (dm == 0) {
                ...
                if (offset1 == 0) {
                    int dh = c[3] - h;
                    if (dh > 0) {
                        // TODO: 11/15/2016 dh hours ago
                        return nHoursAgo(dh);
                    } else {
                        // TODO: 11/15/2016 a moment ago
                        return "چند لحظه پیش";
                    }
                } else {
