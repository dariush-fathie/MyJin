...
interface ApiInterface {
    ...
    @get:GET("service/getQuesAndAnswerList/")
    val quesAndAnswer: Call<List<KotlinAdviceModel>>

    @get:GET("service/getSpecialOffersList/")
    val SpecialOffers: Call<List<KotlinSpecialOffersModel>>
